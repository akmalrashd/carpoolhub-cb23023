<aside class="desktop-sidebar">
    <nav class="desktop-nav">
        ...
        <a href="{{ route('explore.index') }}" class="{{ request()->routeIs('explore.*') ? 'active' : '' }}">
            <i class="fa-solid fa-compass"></i><span class="desktop-nav-label">Explore Trips</span>
        </a>
        ...
        @if(auth()->check() && auth()->user()->role === 'admin')
            <a href="{{ route('admin.users.index') }}" class="{{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                <i class="fa-solid fa-users-gear"></i><span class="desktop-nav-label">Admin Users</span>
            </a>
