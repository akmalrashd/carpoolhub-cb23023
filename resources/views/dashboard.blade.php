    ...
    <div class="dashboard-shell">
        ...
        <section class="section-card">
            ...
            <div class="quick-actions">
                <a href="{{ route('trips.create') }}" class="quick-link">
                    ...
                    <span class="quick-meta">Create a ride now</span>
                </a>
                <a href="{{ route('saved-routes.create') }}" class="quick-link">
                    ...
                    <span class="quick-meta">Pin favorite routes</span>
                </a>
                <a href="{{ route('payments.index') }}" class="quick-link">
                    ...
                    <span class="quick-meta">Track pending payments</span>
                </a>
                <a href="{{ route('connections.index') }}" class="quick-link">
                    ...
                    <span class="quick-title">Invite Passengers</span>
                    <span class="quick-meta">Manage your carpool group</span>
                </a>
            </div>
        </section>
        ...
        <section class="section-card">
            <div class="section-head">
                ...
                <a href="{{ route('trips.index') }}" class="section-link">View all</a>
            </div>
