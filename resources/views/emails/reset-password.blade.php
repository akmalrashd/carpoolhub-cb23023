                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="margin:0 0 24px; font-family:Arial,Helvetica,sans-serif; font-size:14px; line-height:1.6; color:#64748B;">
                                        Hi{{ $userName ? ' ' . $userName : '' }}, we received a request to reset the
                                        password for your CarpoolHub account
                                    ...
                                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td align="center" style="background-color:#FACC15; border-radius:14px;">
                                                <a href="{{ $resetUrl }}" target="_blank" style="display:inline-block; padding:14px 32px; font-family:Arial,Helvetica,sans-serif; font-size:15px; font-weight:700; color:#2A1E04; text-decoration:none;">
                                                    Reset password
                                                </a>
                                            </td>
                                        </tr>
