...
@section('content')
    <h1 style="margin:0 0 14px; font-family:Poppins, sans-serif;">Admin Users</h1>
    ...
    <div class="card-dark" style="padding:16px; margin-bottom:14px;">
        <form method="GET" action="{{ route('admin.users.index') }}" style="display:grid; gap:10px; grid-template-columns: 1fr 180px 180px auto; align-items:end;">
            ...
            <button type="submit" style="background:#FACC15; color:#111827; border:none; border-radius:8px; padding:10px 12px; font-weight:700;">Filter</button>
        </form>
    </div>
        ...
        <div style="overflow-x:auto;">
            <table style="width:100%; border-collapse:collapse;">
                ...
                <tr>
                    ...
                    <th style="text-align:right; padding:10px; border-bottom:1px solid #374151;">Action</th>
                </tr>
                </thead>
                <tbody>
