...
@section('content')
    ...
    <div style="display:grid; gap:12px; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); margin-bottom:14px;">
        ...
        <div class="card-dark" style="padding:14px;"><div style="color:#9CA3AF;">Drivers</div><div style="font-weight:700;">{{ $overview['drivers_total'] }}</div></div>
        ...
        <div class="card-dark" style="padding:14px;"><div style="color:#9CA3AF;">Fare Total</div><div style="font-weight:700;">RM {{ number_format((float) $overview['fare_total'], 2) }}</div></div>
        <div class="card-dark" style="padding:14px;"><div style="color:#9CA3AF;">Payments Total</div><div style="font-weight:700;">RM {{ number_format((float) $overview['payments_total'], 2) }}</div></div>
    </div>
        ...
        <div style="overflow-x:auto;">
            <table style="width:100%; border-collapse:collapse;">
                ...
                <tr>
                    ...
                    <th style="text-align:right; padding:10px; border-bottom:1px solid #374151;">Trips</th>
                    <th style="text-align:right; padding:10px; border-bottom:1px solid #374151;">Fare Total</th>
